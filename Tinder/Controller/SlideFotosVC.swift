...
class SlideFotosVC: UICollectionViewController,UICollectionViewDelegateFlowLayout {
 let cellId = "cellId"
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(SlideFotosVC.self, forCellWithReuseIdentifier: cellId)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, minimumLineSpacingForSectionAt section: Int) -> CGFloat {                                                              //ESPAÇAMENTO ENTRE OS ITEMS
        return 10
    }
